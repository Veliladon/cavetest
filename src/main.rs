...
fn setup_system(
    ...
    let texture_atlas = TextureAtlas::from_grid(
        texture_handle,
        Vec2::new(SPRITE_WIDTH, SPRITE_WIDTH),
        17,
        12,
        None,
        None,
    ...
    let game_assets = GameAssets { background };

    commands.insert_resource(game_assets);
}

fn set_camera(mut camera_query: Query<&mut Transform, With<Camera>>) {
                ...
                .spawn(SpriteSheetBundle {
                    ...
                    transform: Transform {
                        translation: Vec3::new(
                            x as f32 * SPRITE_WIDTH * SPRITE_SCALE,
                            -(y as f32 * SPRITE_WIDTH * SPRITE_SCALE),
                            1.,
                        ),
                    ...
                    sprite: TextureAtlasSprite::new(
                        map_background[y * MAP_COL + x].try_into().unwrap(),
                    ),
                    ..Default::default()
                })
                .id();
